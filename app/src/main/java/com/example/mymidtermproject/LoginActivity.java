...
import com.example.mymidtermproject.api.RequestPlaceholder;
import com.example.mymidtermproject.api.RetrofitBuilder;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginBtn = this.<MaterialButton>findViewById(R.id.loginBtn);
